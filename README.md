...
helm upgrade --install -n gpu-operator gpu-operator nvidia/gpu-operator \
  --values https://raw.githubusercontent.com/gardenlinux/gardenlinux-nvidia-installer/refs/tags/1.8.0/helm/gpu-operator-values.yaml
```
...
For example: `ghcr.io/gardenlinux/gardenlinux-nvidia-installer/1.8.0/driver:590-6.12.72-cloud-amd64-gardenlinux0`
...
OS 1877.10: 590.48.01, 580.159.03, 580.126.20, 580.126.09, 570.211.01
