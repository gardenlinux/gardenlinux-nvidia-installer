...
helm upgrade --install -n gpu-operator gpu-operator nvidia/gpu-operator \
  --values https://raw.githubusercontent.com/gardenlinux/gardenlinux-nvidia-installer/refs/tags/1.14.0/helm/gpu-operator-values.yaml
```
...
For example: `ghcr.io/gardenlinux/gardenlinux-nvidia-installer/1.14.0/driver:590-6.12.72-cloud-amd64-gardenlinux0`
...
OS 1877.14: 590.48.01, 580.173.02, 580.167.08, 580.159.04, 580.159.03, 580.126.20, 570.211.01
...
OS 2150.1.0: 590.48.01, 580.173.02, 580.167.08, 580.159.04, 580.159.03, 580.126.20, 570.211.01
OS 2150.2.0: 590.48.01, 580.173.02, 580.167.08, 580.159.04, 580.159.03, 570.211.01
...
```bash
helm upgrade --install -n gpu-operator gpu-operator nvidia/gpu-operator \
  --values https://raw.githubusercontent.com/gardenlinux/gardenlinux-nvidia-installer/refs/tags/1.14.0/helm/gpu-operator-gvisor-values.yaml
```
