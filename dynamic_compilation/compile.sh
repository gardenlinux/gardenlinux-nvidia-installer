...
DRIVER_PATH="/run/nvidia/$DRIVER_VERSION/driver"

if [ -d "$DRIVER_PATH" ] && [ -d "$DRIVER_PATH/lib/modules/$KERNEL_NAME" ]; then
    echo "Directory exists for driver version $DRIVER_VERSION."
else
