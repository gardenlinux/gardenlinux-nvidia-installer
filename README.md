...
helm upgrade --install -n gpu-operator gpu-operator nvidia/gpu-operator \
  --values https://raw.githubusercontent.com/gardenlinux/gardenlinux-nvidia-installer/refs/tags/1.19.0/helm/gpu-operator-values.yaml
```
...
For example: `ghcr.io/gardenlinux/gardenlinux-nvidia-installer/1.19.0/driver:590-6.12.72-cloud-amd64-gardenlinux0`
...
```bash
helm upgrade --install -n gpu-operator gpu-operator nvidia/gpu-operator \
  --values https://raw.githubusercontent.com/gardenlinux/gardenlinux-nvidia-installer/refs/tags/1.19.0/helm/gpu-operator-gvisor-values.yaml
```
